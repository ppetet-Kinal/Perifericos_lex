...
ruta_tema_azure = r"C:\Users\Soporte 2\Documents\Phyton\Azure-ttk-theme-main\Azure-ttk-theme-main\azure.tcl"
...
ruta_icono = r"C:\Users\Soporte 2\Documents\Phyton\Logo.ico"
...
def enviar_reporte():
    ...
    datos = {
        ...
        "Reporte de Perifericos": reporte
    }
    ...
    df = df.sort_values(by="nivel_prioridad", key=lambda x: x.map({"Alta": 0, "Media": 1, "Baja": 2}))
    ...
    print("Archivo Excel guardado correctamente con formato.")
